...
set_property PACKAGE_PIN V16 [get_ports {i_dlp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {i_dlp}] 
set_property PACKAGE_PIN W16 [get_ports {i_drp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {i_drp}] 
set_property PACKAGE_PIN W17 [get_ports {i_ilp}] 	 	 	 	 	 
 	set_property IOSTANDARD LVCMOS33 [get_ports {i_ilp}] 
set_property PACKAGE_PIN W15 [get_ports {i_irp}] 	 	 	 	 	 
